...
<script type="text/javascript">
    ...
    {
        if (task == 'controll.cancel') {
            Joomla.submitform(task, document.getElementById('controll-form'));
        }
        else {
            ...
            if (task != 'controll.cancel' && document.formvalidator.isValid(document.id('controll-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_controll&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="controll-form" class="form-validate">
