 ...
 * View to edit
 */
class ControllViewStudent extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('Преподаватель'), '');
        ...
        if (!$checkedOut && ($canDo->get('core.create'))) {
            JToolBarHelper::custom('student.save2new', 'save-new.png',
            'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
        }
        // If an existing item, can save to a copy.
        if (!$isNew && $canDo->get('core.create')) {
            JToolBarHelper::custom('student.save2copy', 'save-copy.png',
