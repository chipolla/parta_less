...
<?php endif;?>
		...
		<table class="table table-striped" id="controllList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'Предметы', 'a.teacher', $listDirn, $listOrder); ?>
				</th>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_controll&task=teacher.edit&id='.(int) $item->id); ?>">
					<?php echo $this->escape($item->teacher); ?></a>
				<?php else : ?>
