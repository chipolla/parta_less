...
<?php endif;?>
      ...
      <div class="btn-group pull-left hidden-phone">
            <select name="filter_teacher" class="inputbox" onchange="Joomla.orderTable()">
              <?php echo JHtml::_('select.options', $TeacherOptions, 'value', 'text', $this->state->get('filter.teacher'));?>
            </select>
       </div>
      <div class="btn-group pull-left hidden-phone">
        <select name="filter_subject" class="inputbox" onchange="Joomla.orderTable()">
          <?php echo JHtml::_('select.options', $SubjectOptions, 'value', 'text', $this->state->get('filter.subject'));?>
        </select>
      </div>
