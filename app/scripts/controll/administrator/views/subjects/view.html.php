 ...
 */
class ControllViewSubjects extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        ControllHelper::addSubmenu('subjects');
    ...
    protected function addToolbar() {
        ...
        if ($canDo->get('core.edit.state')) {
            ...
            if (isset($this->items[0]->state)) {
                ...
                JToolBarHelper::deleteList('', 'subjects.delete', 'JTOOLBAR_DELETE');
            }

            if (isset($this->items[0]->state)) {
                JToolBarHelper::divider();
                JToolBarHelper::archiveList('subjects.archive', 'JTOOLBAR_ARCHIVE');
            }
            if (isset($this->items[0]->checked_out)) {
                JToolBarHelper::custom('subjects.checkin', 'checkin.png', 'checkin_f2.png', 'JTOOLBAR_CHECKIN', true);
            }
        }
        ...
        if (isset($this->items[0]->state)) {
            if ($state->get('filter.state') == -2 && $canDo->get('core.delete')) {
                JToolBarHelper::deleteList('', 'subjects.delete', 'JTOOLBAR_EMPTY_TRASH');
                JToolBarHelper::divider();
        ...
        JHtmlSidebar::setAction('index.php?option=com_controll&view=subjects');
