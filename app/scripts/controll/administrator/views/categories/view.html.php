 ...
 */
class ControllViewCategories extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        ControllHelper::addSubmenu('categories');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_CONTROLL_TITLE_CATEGORIES'), 'categories.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_controll&view=categories');
	...
	protected function getSortFields()
	{
		...
		'a.category_name' => JText::_('COM_CONTROLL_CONTROLLS_NAME'),
