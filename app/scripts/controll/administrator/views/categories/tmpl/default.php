...
<?php endif;?>
		...
		<table class="table table-striped" id="controllList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_CONTROLL_CATEGORY_NAME', 'a.category_name', $listDirn, $listOrder); ?>
				</th>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_controll&task=category.edit&id='.(int) $item->id); ?>">
