...
<?php endif;?>
		...
		<table class="table table-striped" id="controllList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'Предметы', 'a.student', $listDirn, $listOrder); ?>
				</th>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_controll&task=student.edit&id='.(int) $item->id); ?>">
					<?php echo $this->escape($item->student); ?></a>
				<?php else : ?>
					<?php echo $this->escape($item->student); ?>
				<?php endif; ?>
				</td>
