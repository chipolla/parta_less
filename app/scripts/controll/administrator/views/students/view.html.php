 ...
 */
class ControllViewStudents extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        ControllHelper::addSubmenu('students');
    ...
    protected function addToolbar() {
        ...
        JHtmlSidebar::setAction('index.php?option=com_controll&view=students');
	...
	protected function getSortFields()
	{
		...
		'a.student' => JText::_('COM_CONTROLL_CONTROLLS_NAME'),
