...
/**
 * controll Table class
 */
class ControllTablecontroll extends JTable
{
	...
	{
		parent::__construct('#__controll_controll', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_controll.controll.' . $array['id']))
		{
			$actions         = JFactory::getACL()->getActions('com_controll', 'controll');
			$default_actions = JFactory::getACL()->getAssetRules('com_controll.controll.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_controll.controll.' . (int) $this->$k;
	}
