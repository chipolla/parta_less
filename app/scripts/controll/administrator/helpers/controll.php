...
class ControllHelper {
    ...
    public static function addSubmenu($vName = '') {
        JHtmlSidebar::addEntry(
			JText::_('COM_CONTROLL_TITLE_CONTROLLS'),
			'index.php?option=com_controll&view=controlls',
			$vName == 'controlls'
		);
		JHtmlSidebar::addEntry(
			JText::_('COM_CONTROLL_TITLE_CATEGORIES'),
			'index.php?option=com_controll&view=categories',
			$vName == 'categories'
		);
    JHtmlSidebar::addEntry(
    JText::_('Предметы'),
    ...
    JHtmlSidebar::addEntry(
    JText::_('Студенты'),
    'index.php?option=com_controll&view=students',
    $vName == 'students'
    );
    JHtmlSidebar::addEntry(
    JText::_('Группы Студентов'),
    'index.php?option=com_controll&view=studentgroups',
    $vName == 'studentgroups'
    );
		JHtmlSidebar::addEntry(
			JText::_('COM_CONTROLL_TITLE_SETTINGS'),
			'index.php?option=com_controll&view=settings',
			$vName == 'settings'
		);
	...
	public static function getFileURL() {
		$cparams = JComponentHelper::getParams ('com_controll');
		$psettings = & ControllHelper::config();
