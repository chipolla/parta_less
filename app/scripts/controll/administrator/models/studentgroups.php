...
/**
 * Methods supporting a list of StudentGroup records.
 */
class ControllModelStudentGroups extends JModelList {
    ...
    // Select the required fields from the table.
      ...
      $query->from('`#__controll_student_groups` AS a');
    ...
    // Filter by search in title
      ...
      if (!empty($search)) {
        if (stripos($search, 'id:') === 0) {
          ...
          $query->where('( a.studentgroup LIKE '.$search.')');
        }
      }
