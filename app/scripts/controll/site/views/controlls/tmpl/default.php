...
$canDelete = $user->authorise('core.delete', 'com_controll');
...
<form action="<?php echo JRoute::_('index.php?option=com_controll&view=controlls'); ?>" method="post" name="adminForm" id="adminForm">
    <?php echo JLayoutHelper::render('default_filter', array('view' => $this), dirname(__FILE__)); ?>
	   <?php if (isset($this->items[0]->state)): ?>
        ...
        <?php endif; ?>
<section class="inner controll pb30 signle-list">
<?php
if($display_no==1){
            ...
            <div class="span12 pb30">
                <div class="span<?php echo $image_grid;?>">
                 <?php   if (!empty($item->profile_image)){
                    if($readmore==1){
                ?>
                  <a href="<?php echo JRoute::_('index.php?option=com_controll&view=controll&id='.(int) $item->id) ?>">
                ...
                <?php }?>
                  ...
                  <a href="<?php echo JRoute::_('index.php?option=com_controll&view=controll&id='.(int) $item->id) ?>"><?php echo $this->escape($item->name); ?></a> <?php }else{ echo $this->escape($item->name);}?></h3>
                ...
                <blockquote class="left-arrow">
                   <?php if($readmore==1){?>
                   <?php echo substr($item->controll,0,$character_limit).' ...';
					}else{?>
 ...
 <?php endforeach;
    ...
    <?php if ($canCreate): ?>
        <a href="<?php echo JRoute::_('index.php?option=com_controll&task=controllform.edit&id=0', false, 2); ?>"
           class="btn btn-success btn-small"><i
                class="icon-plus"></i> <?php echo JText::_('COM_CONTROLL_ADD_ITEM'); ?></a>
    <?php endif; ?>
...
<script type="text/javascript">
    ...
    function deleteItem() {
        ...
        if (confirm("<?php echo JText::_('COM_CONTROLL_DELETE_MESSAGE'); ?>")) {
            window.location.href = '<?php echo JRoute::_('index.php?option=com_controll&task=controllform.remove&id=', false, 2) ?>' + item_id;
        }
    }
</script>
